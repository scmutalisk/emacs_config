...
#+DESCRIPTION: Loading emacs configuration file using org-babel
...
#+begin_src emacs-lisp
  ...
  ;; disable scrollbar
  (scroll-bar-mode -1)
  ;; y/n instead or yes/no
  (fset 'yes-or-no-p 'y-or-n-p)
  ;; revert mode
  (global-auto-revert-mode t)
  ;; auto indent on return key
  (define-key global-map (kbd "RET") 'newline-and-indent)
  ;; set font style for frames
  (add-to-list 'default-frame-alist '(font . "hack-12"))
  ;; disable scroll bar for frames
  (add-to-list 'default-frame-alist '(vertical-scroll-bars . nil))
  ;; windmove default (shift + left/right arrows)
  ...
  ;; disable auto save list files names
  ...
  ;; remove whitespace on save hook
